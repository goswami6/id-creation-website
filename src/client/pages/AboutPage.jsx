...
const AboutPage = () => {
  ...
  const qualityStandards = [
    { title: "ISO 9001:2026", desc: "Certified high-precision manufacturing protocols.", icon: <CheckCircle2 size={18} /> },
    { title: "Zero-Defect Policy", desc: "Automated AI-driven quality inspection on every unit.", icon: <Microscope size={18} /> },
    { title: "Material Integrity", desc: "Sourcing only aerospace-grade alloys and polymers.", icon: <FlaskConical size={18} /> }
  ];
  const reasons = [
    {
      title: "NEURAL-PRECISION",
      desc: "Our hardware isn't just built; it's engineered with micro-tolerance logic for 100% accuracy.",
      icon: <Zap size={24} />
    },
    {
      title: "TITAN-GRADE QUALITY",
      desc: "Using aerospace-grade materials that withstand extreme industrial thermal cycles.",
      icon: <Shield size={24} />
    },
    {
      title: "SCALABLE SYSTEMS",
      desc: "Modular designs that grow alongside your production needs without overhaul costs.",
      icon: <Layers size={24} />
    },
    {
      title: "GLOBAL STANDARDS",
      desc: "Complying with ISO 9001 and international safety protocols across 30+ countries.",
      icon: <Globe size={24} />
    }
  ];
  return (
            ...
            <div className="space-y-8 md:space-y-10">
              ...
              >
                ...
                <h2 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-tighter leading-[1.1] md:leading-none">
                  WE ENGINEER <br />
                  <span className="text-gray-300 italic">THE IMPOSSIBLE.</span>
                </h2>
              </motion.div>
              ...
              >
                Founded in 2026, our laboratory focuses on high-precision hardware integration.
                We don't just build tools; we architect the physical foundation for next-generation
            ...
            <div className="relative pt-10 md:pt-0">
              ...
              >
                <p className="text-[11px] md:text-xs font-light leading-relaxed">
                  "Our hardware achieves a tolerance level of <span className="text-orange-600 font-bold">0.001mm</span>,
                  setting a new benchmark for industrial manufacturing."
                </p>
              </motion.div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-white/10 border border-white/10">
            ...
            >
              <div className="relative z-10 space-y-6 md:space-y-8">
                ...
                <p className="text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-md">
                  To bridge the gap between complex digital logic and rugged industrial physical hardware,
                  creating tools that empower engineers to build a more efficient world.
                </p>

                <ul className="space-y-4 pt-4 md:pt-6">
                  {['Hyper-Precision Engineering', 'Sustainable Manufacturing', 'Open-Source Integrity'].map((item, i) => (
            ...
            >
              <div className="relative z-10 space-y-6 md:space-y-8">
                ...
                <p className="text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-md">
                  We envision a future where industrial automation is indistinguishable from nature—seamless,
                  silent, and perfectly optimized for the preservation of our planet.
                </p>
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12">
            ...
            <div className="lg:w-2/3 border-t lg:border-t-0 lg:border-l border-gray-100 pt-10 lg:pt-0 lg:pl-20">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
                <div className="space-y-4 md:space-y-6">
                  ...
                  <span className="text-6xl md:text-8xl font-black text-orange-600 block leading-none">12+</span>
                  <h4 className="text-xl font-bold tracking-tight">Years in Industrial R&D</h4>
                  <p className="text-gray-500 font-light leading-relaxed text-sm md:text-base">
                    From small-scale prototyping to global industrial deployment, our journey has been defined by continuous evolution and technical mastery.
                  </p>
                </div>
                <div className="space-y-4 md:space-y-6 lg:pt-20">
                  <span className="text-6xl md:text-8xl font-black text-orange-600 block leading-none">500k</span>
                  <h4 className="text-xl font-bold tracking-tight">Units Deployed Globally</h4>
                  <p className="text-gray-500 font-light leading-relaxed text-sm md:text-base">
                    Our hardware powers infrastructure across 30 countries, maintaining peak performance in the most demanding environments.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative order-1 lg:order-1">
              ...
              >
                <img
                  src="https://images.unsplash.com/photo-1531287702847-c670e934840c?auto=format&fit=crop&q=80"
                  alt="Quality Testing"
      ...
      <section className="bg-[#0A0A0A] text-white py-40 overflow-hidden">
        <div className="max-w-[1600px] mx-auto px-6 md:px-12">
          ...
          >
            ...
            >
              <span className="text-xs font-black uppercase tracking-[0.3em]">Initiate Contact</span>
